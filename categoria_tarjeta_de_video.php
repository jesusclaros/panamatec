        ...
        <div class="col-lg-9">
            <div class="row">
                <div class="col-md-12 text-center mb-4">
                    <a class="h3 text-dark text-decoration-none">TARJETAS DE VIDEO</a>
                </div>
            </div>

            <!-- Productos de la categoría "Tarjeta de Video" -->
            <div class="row">
                <?php
                $sql_productos = "
                    ...
                    WHERE categorias.nombre = 'Tarjeta de Video'
                ";
            ...
            <!-- Fin de los productos de la categoría "Tarjeta de Video" -->
        </div>
