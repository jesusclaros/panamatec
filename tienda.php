...
// Función para obtener subcategorías según una categoría padre
...
<nav class="navbar navbar-expand-lg navbar-light shadow">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="collapse navbar-collapse d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
            ...
            <div class="navbar d-flex">
                <!-- Buscador móvil -->
                <div class="d-lg-none mt-3 mb-4 col-7 col-sm-auto">
...
<div class="container py-5">
    <div class="row">
                ...
                while ($categoria = $result_categorias->fetch_assoc()) {
                    ...
                    <li class="pb-3">
                        <a class="collapsed d-flex justify-content-between h3 text-decoration-none" 
                           data-toggle="collapse" href="#collapse' . $indice . '">
                           ' . $categoria['nombre'] . '
                           <i class="fa fa-chevron-circle-down mt-1"></i>
                        </a>
        ...
        <div class="col-lg-9">
            ...
            <div class="row">
                <?php
                $sql_productos = "SELECT productos.*, categorias.nombre AS categoria_nombre 
                                FROM productos 
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card h-100 product-wap">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        <small class="text-muted">Cantidad disponible: <?php echo htmlspecialchars($producto['cantidad']); ?></small>
                                    </p>
                ...
                <?php
                    ...
                    echo "<div class='col-12 text-center text-danger'>No hay productos disponibles.</div>";
                endif;
                ?>
            </div>
