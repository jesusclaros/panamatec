        ...
        <div class="col-lg-9">
            <div class="row">
                <div class="col-md-12 text-center mb-4">
                    <a class="h3 text-dark text-decoration-none">AURICULARES</a>
                </div>
            </div>

            <!-- Productos de la categoría "Auriculares" -->
            <div class="row">
                <?php
                $sql_productos = "
                    ...
                    WHERE categorias.nombre = 'Auriculares'
                ";
            ...
            <!-- Fin de los productos de la categoría "Auriculares" -->
        </div>
