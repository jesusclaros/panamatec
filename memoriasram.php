                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <a class="h3 text-decoration-none">Memoria RAM 32GB Corsair Vengeance LPX</a>
                                <p class="text-center mb-0">$39.99</p>
                                <button class="btn btn-primary agregar-carrito" data-nombre="Memoria RAM 32GB Corsair Vengeance LPX" data-precio="39.99">Agregar al carrito</button>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-primary agregar-carrito" data-nombre="Memoria RAM 8GB kingston Fury" data-precio="24.99">Agregar al carrito</button>
                            </div>
