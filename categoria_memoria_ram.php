        ...
        <div class="col-lg-9">
            <div class="row">
                <div class="col-md-12 text-center mb-4">
                    <a class="h3 text-dark text-decoration-none">MEMORIAS RAM</a>
                </div>
            </div>

            <!-- Productos de la categoría "Memoria RAM" -->
            <div class="row">
                <?php
                $sql_productos = "
                    ...
                    WHERE categorias.nombre = 'Memoria RAM'
                ";
            ...
            <!-- Fin de los productos de la categoría "Memoria RAM" -->
        </div>
